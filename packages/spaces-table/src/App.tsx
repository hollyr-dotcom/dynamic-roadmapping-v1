...
export function App() {
  ...
  if (view === 'home') {
    return <>
      <HomePage skipCreationModal={concept === 'nameaftercreation'} titleOnly={concept === 'namebeforecreation'} onOpenApp={(importSource?: 'jira' | 'miro' | 'csv') => {
