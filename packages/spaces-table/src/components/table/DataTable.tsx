...
interface DataTableProps {
  ...
  onOpenSidekick?: (row: SpaceRow) => void
...
export function DataTable({ data, fields, onRowClick, onCompanyClick, updatedRows, insightsAllDots, onTableInteract, isImporting, onImportComplete, onMoveToRoadmap, showMoveToRoadmap, onOpenSidekick, onImportSource, onAddRecord, activePage = 'roadmap', animateIn = true, onEmptyInteract }: DataTableProps) {
