...
/* ─── Prompt button: Work on canvas — cursor collaboration hover ─── */
function WorkOnCanvasButton() {
  ...
  return (
    ...
    >
      {/* Cursor cluster — outline 16px idle → filled orange 16px + coloured companions on hover */}
      <div style={{
        position: 'relative',
        width: 20,
        height: 32,
        ...
        {/* Companion 1 (blue) — starts centred behind main, drifts to top-right */}
        <div style={{
          position: 'absolute',
          top: '50%',
          left: 1,
        ...
        {/* Companion 2 (green) — starts centred behind main, drifts to bottom-centre */}
        <div style={{
          position: 'absolute',
          top: '50%',
          left: 1,
        ...
        {/* Main cursor — outline 16px idle, crossfades to filled orange 16px, drifts up-left */}
        <div style={{
          position: 'absolute',
          top: '50%',
          left: 1,
          ...
          {/* Filled orange icon — fades in on hover */}
          <div style={{
            display: 'flex',
            color: '#FE9F4D',
            transition: `opacity 250ms ${EASE}`,
            opacity: hovered ? 1 : 0,
            animation: hovered ? 'cursor-wave-1 2.5s ease-in-out infinite' : 'none',
          }}>
            <IconCursorFilled css={{ width: 16, height: 16 }} />
          </div>
        </div>
...
/* ─── Rocket flame SVG in 16px container (orange, same coordinate space) ─── */
...
/* ─── Prompt button: Move to roadmap ─── */
function MoveToRoadmapButton() {
  const [hovered, setHovered] = useState(false)
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        {/* Coloured ship — overlays outline exactly, fades in on hover, rumbles */}
        <div style={{
          position: 'absolute',
          top: 0,
          left: 0,
        ...
        {/* Flame — overlays same centre, separates down-left on hover */}
        <div style={{
          position: 'absolute',
          top: 0,
          left: 0,
