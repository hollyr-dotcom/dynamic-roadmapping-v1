...
export function TopNavBar({ borderOpacity, scrollFade, databaseTitle, spaceName, isMenuOpen, onToggleMenu, showSharePopover, onDismissSharePopover }: TopNavBarProps) {
  ...
  return (
    ...
    >
      ...
      {/* Share popover — anchor line centered on button, card offset to stay in viewport */}
      {showSharePopover && shareBtnRect && (
        ...
        >
          {/* Anchor: ball + line — offset to align with button center */}
          ...
          >
            ...
            <p className="font-heading font-semibold text-[16px] leading-snug mb-1">Share {spaceName}</p>
