  ...
  return (
    ...
    >
      ...
      <span
        ...
        style={{ fontSize: '32px', padding: '0 4px' }}
      >
        {draft || 'Enter a title ...'}
      </span>
      ...
      <input
        ...
        className="title-input font-heading font-semibold text-[#222428] leading-[1.4] px-1 rounded bg-transparent border-none outline-none cursor-default transition-colors duration-150 hover:bg-[#F1F2F5] hover:cursor-pointer focus:bg-white focus:cursor-text focus:shadow-[0_0_0_2px_white,0_0_0_4px_#2B4DF8]"
      />
    </div>
  )
}
